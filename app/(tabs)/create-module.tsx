...
const subjects = ["Wiskunde", "Fysica", "Chemie", "Informatica", "Techniek", "Anders"];
const subSubjects = ["Meetkunde", "Algebra", "Statistiek", "Mechanica", "Elektriciteit", "Anders"];
...
export default function CreateModuleScreen() {
  ...
  const finalSubSubject = subSubject === "Anders" ? customSubSubject : subSubject;
  ...
  const handleNext = () => {
    ...
    console.log("Vak:", finalSubject);
    console.log("Subvak:", finalSubSubject);
  ...
  return (
    <View style={styles.screen}>
      ...
      <Pressable style={styles.inputBox} onPress={() => setSubjectOpen(!subjectOpen)}>
      ...
      <Text style={styles.label}>Subvak (optioneel)</Text>
      <Pressable style={styles.inputBox} onPress={() => setSubSubjectOpen(!subSubjectOpen)}>
